...
public class HighTierTest2KYEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HighTierTest2KYEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HighTierTest2KYIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HighTierTest2KYIW/InitOutcome.xml").getDocumentElement();
